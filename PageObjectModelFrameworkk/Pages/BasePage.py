...
class BasePage:
    ...
    def moveTo(self, locator):
        ...
        if str(locator).endswith("_XPATH"):
            ...
            element = self.driver.driver.find_element(By.CSS_SELECTOR,configReader.readConfig("locators", locator))
        elif str(locator).endswith("_ID"):
            element = self.driver.driver.find_element(By.ID,configReader.readConfig("locators", locator))
